...
CREATE TABLE public.vendor_settings (
    ...
    business_hours json,
    payment_collection_model character varying NOT NULL DEFAULT 'on-site' :: character varying,
    accept_cash boolean NOT NULL DEFAULT true,
    accept_cash_takeaway boolean NOT NULL DEFAULT true,
    accept_card boolean NOT NULL DEFAULT true,
    accept_apple_pay boolean NOT NULL DEFAULT false,
    ...
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    accept_visa boolean NOT NULL DEFAULT true,
    accept_mastercard boolean NOT NULL DEFAULT true,
    accept_amex boolean NOT NULL DEFAULT false,
