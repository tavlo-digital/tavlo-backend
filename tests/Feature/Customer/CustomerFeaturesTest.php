...
class CustomerFeaturesTest extends TestCase
{
    ...
    public function test_can_get_account_order_history_grouped_and_paginated_by_session(): void
    {
        ...
        $this->getJson('/api/customer/orders/history?per_page=1&page=1', $this->headers)
            ...
            ->assertJsonPath('history.0.table.id', (string) $newerSession->restaurant_table_id)
            ->assertJsonPath('history.0.table.number', 1)
            ->assertJsonPath('history.0.table.name', 'Table 1')
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('history.0.table.id', (string) $olderSession->restaurant_table_id)
            ->assertJsonPath('history.0.table.number', 1)
            ->assertJsonPath('history.0.table.name', 'Table 1')
