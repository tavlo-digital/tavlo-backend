...
class ReservationController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = Reservation::where('customer_id', $customer->id)
            ->with([
                'vendor:id,vendor_public_id,restaurant_name,address,city',
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'reservation' => $this->formatReservation($reservation->load([
    ...
    public function show(Request $request, string $reservationPublicId): JsonResponse
    {
        $reservation = Reservation::where('reservation_public_id', $reservationPublicId)
            ...
            ->with([
                'vendor:id,vendor_public_id,restaurant_name,address,city,phone',
                'vendor.vendorSetting:id,vendor_id,date_format,time_format',
            ])
            ->firstOrFail();
    ...
    private function formatReservation(Reservation $reservation): array
    {
        ...
        $payload['date'] = $this->dateTimes->formatDate($reservation->date, $reservation->vendor);
        $payload['time'] = $this->dateTimes->formatTime($reservation->time, $reservation->vendor);
        $payload['created_at'] = $this->dateTimes->formatDateTime($reservation->created_at, $reservation->vendor);
        $payload['updated_at'] = $this->dateTimes->formatDateTime($reservation->updated_at, $reservation->vendor);
