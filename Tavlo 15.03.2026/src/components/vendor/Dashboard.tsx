  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {!isLocked && vendorStatus !== 'ready-to-configure' && (
      ...
      {/* Guided Enablement Panel - Only show when ready to configure */}
      {vendorStatus === 'ready-to-configure' && (
      ...
      {/* Only show operational dashboard if live */}
      {vendorStatus !== 'ready-to-configure' && (
        <>
